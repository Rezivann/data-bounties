...
const createBuild = ({
  ...
  if ((platformConfig === null || platformConfig === void 0 ? void 0 : platformConfig.automaticPodsInstallation) || args.forcePods) {
    const isAppRunningNewArchitecture = (platformConfig === null || platformConfig === void 0 ? void 0 : platformConfig.sourceDir) ? await (0, _getArchitecture.default)(platformConfig === null || platformConfig === void 0 ? void 0 : platformConfig.sourceDir) : undefined;
